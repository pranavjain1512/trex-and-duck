...
var trex, trex_running, trex_collided , trex_ducked;
var ground, invisibleGround, groundImage;

var cloudsGroup, cloudImage;
var obstaclesGroup, obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6;

var crowsGroup , crowImage ;
...
function preload(){
  ...
  trex_ducked = loadAnimation ("duck.png");
...
function setup() {
 ...
 console.log(message)
  ...
  trex. addAnimation("ducking" , trex_ducked);
  trex.scale = 0.5;
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if (keyWentDown(DOWN_ARROW)){
      trex.changeAnimation("ducking" ,trex_ducked )
    }
...
function spawnCrows(){
  ...
  if (frameCount% 200 === 0 ){
    ...
    crow.y = Math.round(random(60,80));
